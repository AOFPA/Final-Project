...
//block สำหรับ config ขาของ Relay
Blockly.Blocks['relayonemodule'] = {
    init: function() {
      this.appendDummyInput()
          .setAlign(Blockly.ALIGN_CENTRE)
          .appendField("RelayOneModule");
      this.appendDummyInput()
          .setAlign(Blockly.ALIGN_CENTRE)
          .appendField(new Blockly.FieldImage("https://inwfile.com/s-dy/50aa6b.jpg", 150, 150, { alt: "*", flipRtl: "FALSE" }));
      this.appendDummyInput()
          .appendField("RelayOneModule")
